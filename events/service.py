...
services = {
    1: {
        'category': 'DIY基本組裝',
        'img_url': 'https://i.imgur.com/A2Ttsfl.jpg',
        'title': '基本組裝（貼紙）',
        'duration': '90min',
        'description': '給模型組裝新手的基本組合，開盒直接組裝',
        'price': 200,
        'post_url': 'https://linecorp.com'
    },
    2: {
        'category': 'DIY進階組裝',
        'img_url': 'https://i.imgur.com/nciIIL2.jpg',
        'title': '進階組裝（改裝/噴漆）',
        'duration': '120min',
        'description': '模型客製化，顏色、零件自由改裝',
        'price': 500,
        'post_url': 'https://linecorp.com'
    },
}
...
def service_category_event(event):
    image_carousel_template_message = TemplateSendMessage(
        ...
        template=ImageCarouselTemplate(
            columns=[
                ImageCarouselColumn(
                    image_url='https://i.imgur.com/A2Ttsfl.jpg',
                    action=PostbackAction(
                        label='DIY基本組裝',
                        display_text='想了解DIY基本組裝',
                        data='action=service&category=DIY基本組裝'
                    )
                ),
                ImageCarouselColumn(
                    image_url='https://i.imgur.com/nciIIL2.jpg',
                    action=PostbackAction(
                        label='DIY進階組裝',
                        display_text='DIY進階組裝',
                        data='action=service&category=DIY進階組裝'
                    )
                )
            ]
        )
